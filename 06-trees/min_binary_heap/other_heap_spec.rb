...
RSpec.describe MinBinaryHeap, type: Class do
  ...
  describe "#insert(data)" do
    ...
    #   expected_output = "Pacific Rim: 72\nThe Matrix: 87\nStar Wars: Return of the Jedi: 80\n"
      tree2 = MinBinaryHeap.new(jedi)
      expect(tree2.root.title).to eq "Star Wars: Return of the Jedi"
    #   tree.insert(root, jedi)
      tree2.insert(jedi, pacific_rim)
      expect(tree2.root.title).to eq "Pacific Rim"
      expect(tree2.root.left.title).to eq "Star Wars: Return of the Jedi"
